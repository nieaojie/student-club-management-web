  ...
  <div>
    ...
    <el-card class="box-card">
      <el-row :gutter="20">
        ...
        <!--新增和批量删除-->
        <el-button @click="addNew" type="primary" style="float: left"><i class="el-icon-circle-plus-outline"></i>&nbsp;&nbsp;新增班级
        </el-button>
        ...
        <div style="overflow-y:scroll;height: 350px">
          <el-form :label-position="labelPosition" label-width="80px"
            ...
            <el-form-item label="所属专业">
              <el-input v-if="formData.specialtyDTO!=null" readonly v-model="formData.specialtyDTO.name"></el-input>
            </el-form-item>
        ...
        <el-dialog title="编辑" :visible.sync="editFormDialog" :close-on-click-modal="false" :lock-scroll="true"
          ...
          <div style="overflow-y:scroll;height: 350px">
            <el-form :label-position="labelPosition"
              ...
              <el-form-item label="所属专业" prop="specialtyPkid">
                <el-cascader
                    v-model="editRuleForm.specialtyPkid"
                    :options="options"
      ...
      <!--新增表单弹窗-->
      <div>
        <el-dialog title="新增班级" :visible.sync="addFormDialog" :close-on-click-modal="false" :lock-scroll="true"
          ...
          <div style="overflow-y:scroll;height: 350px">
            <el-form :label-position="labelPosition"
              ...
              <el-form-item label="所属专业" prop="specialtyPkid">
                <el-cascader
                    v-model="ruleForm.specialtyPkid"
                    :options="options"
                    @change="handleChange"></el-cascader>
              </el-form-item>
            </el-form>
...
<script>
import {createEntity, deleteByIds, getCollegeAndSpecialtyTree, info2, list2, searchByLike, update} from "@/api/class";
...
export default {
  ...
  methods: {
     ...
     * 获取院系专业树形列表
     */
    getCollegeAndSpecialtyTree() {
      getCollegeAndSpecialtyTree().then(res => {
        if (res.data.code === '0') {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          param.specialtyPkid = param.specialtyPkid[1];
          createEntity(param)
              .then((res) => {
                // console.log(res)
                if (res.data.code === '0') {
    ...
    handleEdit(row) {
      ...
      info2(row.pkid).then(res => {
        if (res.data.code === '0') {
          ...
          this.editRuleForm.specialtyPkid = new Array(res.data.data.specialtyDTO.collegeEntity.pkid, res.data.data.specialtyDTO.pkid);
        } else {
          console.log(res.data.msg);
        }
      });
      this.getCollegeAndSpecialtyTree();
