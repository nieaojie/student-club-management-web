  ...
  <div>
    ...
    <el-card class="box-card">
      <el-row :gutter="20">
        ...
        <!--新增和批量删除-->
        <el-button @click="addNew" type="primary" style="float: left"><i class="el-icon-circle-plus-outline"></i>&nbsp;&nbsp;新增院系
        </el-button>
      ...
      <!--新增表单弹窗-->
      <div>
        <el-dialog title="新增院系" :visible.sync="addFormDialog" :close-on-click-modal="false" :lock-scroll="true"
          ...
          <div style="overflow-y:scroll;height: 350px">
            <el-form :label-position="labelPosition"
                     ...
                     style="width: 100%">
              <el-form-item label="院系名称" prop="name">
                <el-input v-model="ruleForm.name" placeholder="请输入院系名称"></el-input>
              </el-form-item>
            </el-form>
          </div>
          <div slot="footer" class="dialog-footer">
...
<script>
import {searchByLike, list, createEntity, update, deleteByIds, info} from "@/api/college";
